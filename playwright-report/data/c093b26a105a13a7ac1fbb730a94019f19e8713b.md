...
- Name: known-defects.spec.ts >> Known defects — problem_user >> BUG-003 a product added to the cart should be removable
- Location: tests/known-defects.spec.ts:30:7
      ...
      - generic [ref=e24]:
        ...
        - generic [ref=e28]:
          ...
          - generic [ref=e33]:
            ...
            - button "Remove" [active] [ref=e35] [cursor=pointer]
      - generic [ref=e36]:
